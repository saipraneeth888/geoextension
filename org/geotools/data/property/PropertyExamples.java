    ...
    public static void main(String[] args) {
       /* File tmp = null;
        ...
        /*    File example = new File(tmp, "example.properties");
            ...
            writer.write("_=id:Integer,name:String,geom:Polygon,srval:Float");
            writer.newLine();
         //   writer.write("fid1=1|jody garnett|POLYGON(80.45269167859107  -212.7334765609122,231.60891905776697  -212.7334765609122,231.60891905776697  -418.44905228405105,80.45269167859107  -418.44905228405105,80.45269167859107  -212.7334765609122)|2.1");
            writer.write("fid1=1|jody garnett|POINT(0 0)|1");
            writer.newLine();
        //    writer.write("fid2=2|brent|POLYGON(2659.9471281374285  -212.73347656091255,2811.1033555166046  -212.73347656091255,2811.1033555166046  -418.4490522840514,2659.9471281374285  -418.4490522840514,2659.9471281374285  -212.73347656091255)|3.1");
            writer.write("fid2=2|brent|POINT(10 10)|2");
            writer.newLine();
          writer.write("fid3=3|dave|POINT(20 20)|3");
            writer.newLine();
            writer.write("fid4=4|justin deolivera|POINT(30 30)|4");
            writer.newLine();
            writer.close();*/
   ...
   // }
    ...
    private static void example3() throws IOException {
       ...
       // 		DataStoreFinder.getDataStore(params);
        ...
        Query query = new Query("examples");
        FeatureReader<SimpleFeatureType, SimpleFeature> reader = datastore
                .getFeatureReader(query, Transaction.AUTO_COMMIT);

 
        File file = new File(directory, "examples.properties");
        PropertyAttributeReader readers = new PropertyAttributeReader(file);
     //   readers.next();
    //    System.out.println("a"+readers.);
        try {
            int count = 0;
    ...
    private static void example4() throws IOException {
        ...
        Query query = new Query("examples", filter);
